...
const SETTINGS = (
  <svg className={style.settings} width="19" height="19" viewBox="0 0 35 35" fill="none" xmlns="http://www.w3.org/2000/svg">
...
>>>>>>> Stashed changes
  ...
  return (
    <>
        {settingsOpen && <UserSettings setSettingsOpen={setSettingsOpen} mobile />}
